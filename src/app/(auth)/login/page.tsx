    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">MBRMS</h1>
          <p className="text-gray-500 text-sm mt-1">Marketing & Branding Requirement Management</p>
        </div>
        ...
        <div className="mt-6 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
          ...
          <p>superadmin@mbrms.com · admin@mbrms.com</p>
          <p>manager@mbrms.com · team@mbrms.com</p>
